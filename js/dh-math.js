...
const DHMath = (() => {
  ...
  function generatePrime(bits) {
    if (bits > 64) {
      // For display only — return well-known safe primes for large sizes
      const knownPrimes = {
        128: BigInt('0xFFFFFFFFFFFFFFFFC90FDAA22168C235'),
        256: BigInt('0xFFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1' +
                    '29024E088A67CC74020BBEA63B139B22514A08798E3404DD'),
        512: BigInt('2').pow === undefined
          ? 
          : 0n,
      };
